...
execute unless stopwatch divinity30s ..29.9 run execute if score @s divinity matches 4 run effect give @s minecraft:absorption 30 3 true
execute unless stopwatch divinity15s ..14.9 run execute if score @s divinity matches 5 run effect give @s minecraft:absorption 15 4 true
