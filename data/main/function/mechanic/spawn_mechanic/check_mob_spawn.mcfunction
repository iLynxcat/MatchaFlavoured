...
execute at @s run execute if dimension minecraft:overworld run execute if entity @s[type=minecraft:creeper] if predicate main:surface_spawn run tag @s add SpawnForbidden
