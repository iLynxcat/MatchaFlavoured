...
#Weak Skeletons
execute as @s[type=#minecraft:skeletons] run attribute @s minecraft:max_health base set 12
execute as @s[type=#minecraft:skeletons] run data merge entity @s {equipment:{mainhand:{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{"punch":2}}}},drop_chances:{mainhand:0.000}}
#Weak Creepers
execute as @s[type=minecraft:creeper] run attribute @s minecraft:max_health base set 18
#Weak but Fast Cavespiders
execute as @s[type=minecraft:cave_spider] run attribute @s minecraft:max_health base set 6
execute as @s[type=minecraft:cave_spider] run attribute @s minecraft:movement_speed base set 0.42
...
execute as @s[type=minecraft:husk,nbt={IsBaby:1b}] run attribute @s minecraft:max_health base set 5
...
execute at @s[type=minecraft:spider] run effect give @n minecraft:weaving infinite 1 true