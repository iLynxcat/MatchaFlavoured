...
#MatchaMC: base 0.4 -> 0.3
execute as @s[type=minecraft:zombie,nbt={IsBaby:0b}] run attribute @s minecraft:movement_speed base set 0.3
#MatchaMC: base (vanilla)3.0 -> 1.5
execute as @s[type=minecraft:zombie,nbt={IsBaby:0b}] run attribute @s minecraft:entity_interaction_range base set 1.2
