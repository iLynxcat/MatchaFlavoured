...
# Fork tuning (was 0.28 before 1.10): execute as @s[type=minecraft:husk,nbt={IsBaby:0b}] run attribute @s minecraft:movement_speed base set 0.28
execute as @s[type=minecraft:husk,nbt={IsBaby:0b}] run attribute @s minecraft:attack_damage base set 15
# Fork tuning (was 7 before 1.10): execute as @s[type=minecraft:husk,nbt={IsBaby:0b}] run attribute @s minecraft:attack_damage base set 7
