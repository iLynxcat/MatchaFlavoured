...
execute as @e[type=minecraft:armor_stand,tag=WardingStone] unless entity @s[type=minecraft:armor_stand,tag=WardingStoneSetup] run function main:mechanic/warding_stone/warding_stone_particles
function main:mechanic/warding_stone/warding_stone_effects
execute at @e[type=minecraft:armor_stand,tag=WardingStoneSetup] run execute unless block ~ ~ ~ minecraft:lodestone run function main:mechanic/warding_stone/warding_stone_killer
